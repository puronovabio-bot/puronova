        ...
        <div className="footer-grid">
          <div className="footer-brand-col">
            ...
            <div className="social-icons">
              <a href="https://www.instagram.com/puronova.in?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" aria-label="Instagram Puro Nova" target="_blank" rel="noopener noreferrer">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
                <span style={{ fontSize: '12px', marginLeft: '5px' }}>@puronova.in</span>
              </a>
